...
Upload Video: Click "Upload a video file" and select your MP4, AVI, MOV, or MKV file

Select Target Language: Choose from 11 supported languages in the dropdown menu

Choose Voice Gender: Select either Male or Female voice for the target language

Convert Video: Click "Convert Video" to start the processing pipeline

Monitor Progress: Watch the real-time progress bar and status updates

Preview Results: Review the transcription, translation, and hear the generated audio

Download: Click "Download" to save the converted video to your device
...
Duration Analysis: Uses FFprobe to measure exact video and audio durations

Tempo Adjustment: Calculates speed factor as video_duration / audio_duration

Audio Processing: Applies FFmpeg atempo filter to match durations precisely

Quality Preservation: Maintains 48kHz sample rate and AAC encoding for optimal quality
...
Hardware Used for Benchmarks: Laptop RTX 4060 GPU

Optimization Tips
GPU Acceleration: Whisper runs significantly faster on CUDA-enabled GPUs​

Model Selection: Use "tiny" or "base" Whisper models for faster processing at slightly lower accuracy

Batch Processing: Process multiple videos sequentially to amortize model loading time

Caching: The application caches Whisper models in venv/ to avoid re-downloading​
...
Open Pull Request: Submit PR with detailed description of changes
...
📧 Contact
Yashwanth Balaji - @Yashwanth2408

Project Repository: Speech-to-Speech-Streaming-Project
